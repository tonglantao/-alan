...
bcell_path = os.path.join(r'D:\lbq\dataset\0_gjj\dataset\07_MultipleFluorescence\漫性大B细胞淋巴瘤\B细胞\JPEGImages')
virus_path = os.path.join(r'D:\lbq\dataset\0_gjj\dataset\07_MultipleFluorescence\漫性大B细胞淋巴瘤\巨噬细胞\JPEGImages')
nucle_path = os.path.join(r'D:\lbq\dataset\0_gjj\dataset\07_MultipleFluorescence\漫性大B细胞淋巴瘤\细胞核\JPEGImages')

bcell_seg = os.path.join(
    r'D:\lbq\dataset\0_gjj\dataset\07_MultipleFluorescence\漫性大B细胞淋巴瘤\cityscapes\B细胞\SegmentationClass')
nucle_seg = os.path.join(
    r'D:\lbq\dataset\0_gjj\dataset\07_MultipleFluorescence\漫性大B细胞淋巴瘤\cityscapes\细胞核\SegmentationClass')
virus_seg = os.path.join(
    r'D:\lbq\dataset\0_gjj\dataset\07_MultipleFluorescence\漫性大B细胞淋巴瘤\cityscapes\巨噬细胞\SegmentationClass')
...
for root, dirs, files in os.walk(path):
    for dir in dirs:
        ...
        for filename in os.listdir(sub_dir):
            ...
            if src: #合成图
                ...
                if src_green:
                    ...
                    # bcell_dst.save(bcell_path + '/' + dir + '.jpg')
                if src_blue:
                    zeros = np.zeros(src_single.shape, dtype="uint8")
                    nuclei_im = np.stack((
                        zeros,
                    ...
                    # nucle_dst.save(nucle_path + '/' + dir + '.jpg')
        ...
        # virus_dst.save(virus_path + '/' + dir + '.jpg')
